...
imageSizes.set('simpukka1.png', { scale: new Vector3().setScalar(0.5), rotation: new Euler(-Math.PI / 2), offset: new Vector3(0, 0.1, 0), shadowSize: new Vector3(0.0, 0.0, 0.0) })
imageSizes.set('simpukka2.png', { scale: new Vector3().setScalar(0.5), rotation: new Euler(-Math.PI / 2), offset: new Vector3(0, 0.1, 0), shadowSize: new Vector3(0.0, 0.0, 0.0) })
