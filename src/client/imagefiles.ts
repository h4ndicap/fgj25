...
imageSizes.set('lusikka.png', { scale: new Vector3().set(1, 300 / 200, 1), rotation: new Euler(-Math.PI / 2), offset: new Vector3(0, 0.0, 0), shadowSize: new Vector3(0.0, 0.0, 0.0), randomRotation: 2 })
...
imageSizes.set('hole.png', { scale: new Vector3().setScalar(2.5), rotation: new Euler(-Math.PI / 2), offset: new Vector3(0, 0, 0), shadowSize: new Vector3(0.0, 0.0, 0.0) })
imageSizes.set('VOITTORUUTU.png', { scale: new Vector3(934 / 251, 1, 1), shadowSize: new Vector3(0.0, 0.0, 0.0) })
